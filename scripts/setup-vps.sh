...
echo "  Rule 2: http.host eq 'engineerfamily.net' or http.host eq 'www.engineerfamily.net' or http.host eq 'streamlit.engineerfamily.net' or http.host eq 'umami.engineerfamily.net' or http.host eq 'umami.engineerfamily.net' → Set origin port to 80 (default, may not need a rule)"
